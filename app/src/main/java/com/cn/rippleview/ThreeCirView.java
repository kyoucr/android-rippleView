...
public class ThreeCirView extends RelativeLayout {
    ScaleAnimation animation1;
    ScaleAnimation animation2;

    public ThreeCirView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
//        initView();
    }

    public ThreeCirView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
//        initView();
    }

    public ThreeCirView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
//        initView();
    }
